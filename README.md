...
- **Tests** (`test.yml`) — the full vitest unit suite, **`bun run test`**
  (3,016 tests across 133 files, all passing — counts as of 2026-09-24;
...
| `tests/unit/` | The vitest suite (133 files, 3,016 tests — counts as of 2026-09-24; re-run vitest for current) — unit-level, no DB or secrets needed (critical-path suites use a throwaway real SQLite file) |
