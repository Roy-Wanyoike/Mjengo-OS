...
- **Tests** (`test.yml`) — the full vitest unit suite, **`bun run test`**
  (2,704 tests across 118 files, all passing — counts as of 2026-09-18;
...
| `tests/unit/` | The vitest suite (118 files, 2,704 tests — counts as of 2026-09-18; re-run vitest for current) — unit-level, no DB or secrets needed (critical-path suites use a throwaway real SQLite file) |
