...
- **Tests** (`test.yml`) — the full vitest unit suite, **`bun run test`**
  (2,948 tests across 131 files, all passing — counts as of 2026-09-24;
...
| `tests/unit/` | The vitest suite (131 files, 2,948 tests — counts as of 2026-09-24; re-run vitest for current) — unit-level, no DB or secrets needed (critical-path suites use a throwaway real SQLite file) |
