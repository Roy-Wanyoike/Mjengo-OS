...
- **Tests** (`test.yml`) — the full vitest unit suite, **`bun run test`**
  (2,678 tests across 116 files, all passing — counts as of 2026-09-18;
...
| `tests/unit/` | The vitest suite (116 files, 2,678 tests — counts as of 2026-09-18; re-run vitest for current) — unit-level, no DB or secrets needed (critical-path suites use a throwaway real SQLite file) |
