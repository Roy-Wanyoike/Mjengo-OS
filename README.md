...
- **Tests** (`test.yml`) — the full vitest unit suite, **`bun run test`**
  (2,782 tests across 123 files, all passing — counts as of 2026-09-22;
...
| `tests/unit/` | The vitest suite (123 files, 2,782 tests — counts as of 2026-09-22; re-run vitest for current) — unit-level, no DB or secrets needed (critical-path suites use a throwaway real SQLite file) |
