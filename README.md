...
- **Tests** (`test.yml`) — the full vitest unit suite, **`bun run test`**
  (3,040 tests across 135 files, all passing — counts as of 2026-09-25;
...
| `tests/unit/` | The vitest suite (135 files, 3,040 tests — counts as of 2026-09-25; re-run vitest for current) — unit-level, no DB or secrets needed (critical-path suites use a throwaway real SQLite file) |
