...
- **Tests** (`test.yml`) — the full vitest unit suite, **`bun run test`**
  (2,658 tests across 115 files, all passing — counts as of 2026-09-21;
...
| `tests/unit/` | The vitest suite (115 files, 2,658 tests — counts as of 2026-09-21; re-run vitest for current) — unit-level, no DB or secrets needed (critical-path suites use a throwaway real SQLite file) |
