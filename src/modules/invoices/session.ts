...
//
// applyAction() (src/lib/mjengo.ts) strips the __actor/__role overrides before
...
// This module is imported ONLY through src/lib/actions/invoices.ts, which is
// server-only (client files import types from '@/lib/mjengo' with `import
