...
// src/shared/permissions.ts ROLE_TABS, and this component ALSO renders an
...
const AUDIT_KINDS: readonly string[] = [
  ...
  'document', // API-2 (issue #153): document uploads + the human review verdicts (Copilot "Documents" panel)
]
