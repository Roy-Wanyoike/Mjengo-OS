...
import { ParcelsSection } from '@/components/mjengo/land/sections/parcels-section'
import { ProfessionalsSection } from '@/components/mjengo/land/sections/professionals-section'
