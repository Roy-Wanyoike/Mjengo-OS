...
/**
 * /platform — final CTA band. Compact local version of the homepage CTA
 * section pattern (survey grid + contours + centered actions).
 */
export function PlatformCTA() {
  return (
    <section aria-labelledby="platform-cta-heading" className="relative overflow-hidden bg-forest-900">
      ...
      <Container className="relative py-16 text-center sm:py-20">
        ...
        <Reveal delay={80}>
          ...
          >
            One record for the whole build.
          </h2>
        </Reveal>
        <Reveal delay={160}>
          <p className="mx-auto mt-5 max-w-xl text-[16px] leading-relaxed text-forest-300/90">
            Start your next project on MjengoOS — or talk to us about how the modules
            fit the way you already build.
          </p>
        </Reveal>
        <Reveal delay={240} className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Button href="/pricing" size="lg" variant="outline-dark">
            View pricing
          </Button>
        </Reveal>
        <Reveal delay={320}>
