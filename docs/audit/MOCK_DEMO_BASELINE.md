...
| Consumption / stock reconciliation | **NO TESTS** | src/backend/modules/inventory/{service,repository}.ts have ZERO test files; Consumption model exists (seed wipes it) — untested logic |
