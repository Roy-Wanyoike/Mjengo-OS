# MjengoOS — Product Blueprint (Vision Document)

> **What this document is:** the full product blueprint — the complete designed
> behaviour of every MjengOS domain, written by the founder. It describes the
> system as *designed to be*, end to end.
>
> **What is shipped today:** see [`README.md`](../README.md) (root) — the
> audited, recruiter-grade summary of what runs in this repo right now, with
> honest notes on sandbox seams (M-Pesa Daraja sandbox, USSD simulation,
> WhatsApp simulator, flag-gated AI default-off).
>
> Read this blueprint for direction and depth; read the README for the
> shipping truth. Where the two differ on a capability's status, the README
> wins. Blueprint sections describing payment rails, multi-currency, bank
> integrations and telco production gateways are design targets, not shipped
> surface.
